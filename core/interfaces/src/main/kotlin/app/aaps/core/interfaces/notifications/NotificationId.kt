...
enum class NotificationId(
    ...
    // Pump - Tandem
    TANDEM_BASAL_PROFILE_ERROR(95, NORMAL, PUMP),
    TANDEM_SITE_REMINDER(96, INFO, PUMP),
    TANDEM_PUMP_SETTINGS_UPDATED(97, INFO, PUMP),
    TANDEM_PUMP_MESSAGE_ERROR(98, INFO, PUMP),
