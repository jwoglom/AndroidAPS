...
class ResultCommandResponse(commandType: PumpCommandType?, success: Boolean, errorDescription: String?) : CommandResponseAbstract<Boolean?>(commandType, success, errorDescription, success) {
