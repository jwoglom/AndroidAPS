...
class TandemDatabaseModule {
    ...
    @Provides
    @Singleton
    internal fun provideDatabase(context: Context): TandemPumpDatabase = TandemPumpDatabase.build(context)

    @Provides
    @Singleton
    internal fun provideHistoryRecordDao(historyDatabase: TandemPumpDatabase): TandemHistoryRecordDao = historyDatabase.historyRecordDao()
