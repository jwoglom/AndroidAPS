...
class TandemSlimPumpPlugin @Inject constructor(
    ...
    PluginDescription() //
        ...
        .fragmentClass(TandemSlimPumpFragment::class.java.name) //
        .pluginIcon(R.drawable.ic_tslim_128)
        .pluginName(R.string.tandem_name_slim) //
        .shortName(R.string.tandem_name_slim_short) //
        .preferencesId(R.xml.pref_tandem_slim)
        .description(R.string.description_pump_tandem_slim),  //
    ...
    override fun initPumpStatusData() {
        ...
        pumpStatus.pumpDriverMode = PumpDriverMode.Demo
        pumpStatus.pumpType = PumpType.TANDEM_T_SLIM_X2_BT
...
//;;
    ...
    private fun setDriverMode() {
        ...
        //     }
        // } else
            this.driverMode = PumpDriverMode.Demo
    }
